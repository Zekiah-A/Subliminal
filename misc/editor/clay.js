/*
NOTE
Portions of this file are adapted from https://github.com/nicbarker/clay/blob/main/examples/clay-official-website/index.html..
The source code in this file is compatible with clay version 0.14.
...
const imageRenderDataDefinition = { type: "struct", members: [
	{ name: "backgroundColor", ...colorDefinition },
	{ name: "cornerRadius", ...cornerRadiusDefinition },
	{ name: "imageData", type: "uint32_t" },
]};
const customRenderDataDefinition = { type: "struct", members: [
	{ name: "backgroundColor", ...colorDefinition },
	{ name: "cornerRadius", ...cornerRadiusDefinition },
...
const customHTMLDataDefinition = { type: "struct", members: [
...
function readStructAtAddress(address, definition) {
	switch(definition.type) {
		...
		case "double": return { value: memoryDataView.getFloat64(address, true), __size: 8 };
		case "uint64_t": return { value: memoryDataView.getBigUint64(address, true), __size: 8 };
		case "int64_t": return { value: memoryDataView.getBigInt64(address, true), __size: 8 };
